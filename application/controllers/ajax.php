...
class Ajax extends CI_Controller {
	...
	public function __construct(){
		...
		$this->data['active_link']  = 'ajax';
		$this->data['page_title']   = 'AJAX';
    }
...
/* Public Methods */
    ...
    public function refreshregistered(){
        // Load Helpers
    ...
    public function updatemypsn(){
        ...
        $this->update_psn($this->data['user']);
    }

    public function updatemyxbl(){
        // Load Helpers
        $this->load->helper('api');
        $this->load->helper('xbl_api');
        ...
        $this->update_xbl($this->data['user']);
    }
